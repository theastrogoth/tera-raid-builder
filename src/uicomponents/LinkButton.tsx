...
const LEGACY_HASHES = ["venusaur/winter_migration", "iron_leaves/krook", "walking_wake/charging_wake", "walking_wake/shocking_wake", "walking_wake/metro_express", "feraligatr/latr_gatr_3"]
