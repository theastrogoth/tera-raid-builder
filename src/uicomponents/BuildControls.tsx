...
function BuildControls({pokemon, abilities, moveSet, setPokemon, substitutes, setSubstitutes, groups, setGroups, prettyMode, translationKey, isBoss = false}: 
    ...
    {
    const [genSpecies, ] = useState([...gen.species].map(specie => specie.name).filter((n) => !["Mimikyu-Busted", "Eiscue-Noice", "Morpeko-Hangry", "Terapagos-Stellar", "Meloetta-Pirouette"].includes(n)).sort());
