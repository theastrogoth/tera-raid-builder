...
export function raiderFromData(data: State.Raider) {
    return new Raider(
        data.id,
        data.role,
        data.shiny,
        ...
        new Pokemon(gen, data.name, {
            level: data.level,
            bossMultiplier: data.bossMultiplier,
            statMultipliers: data.statMultipliers,
            ability: data.ability,
            abilityOn: data.abilityOn,
            isDynamaxed: data.isDynamaxed,
            dynamaxLevel: data.dynamaxLevel,
            isSaltCure: data.isSaltCure,
            alliesFainted: data.alliesFainted,
            boostedStat: data.boostedStat,
            usedBoosterEnergy: data.usedBoosterEnergy,
            isIngrain: data.isIngrain,
            isSmackDown: data.isSmackDown,
            item: data.item,
            gender: data.gender,
            nature: data.nature,
            rawStats: data.rawStats,
            stats: data.stats,
            ivs: extend(true, {}, data.ivs),
            evs: extend(true, {}, data.evs),
            boosts: extend(true, {}, data.boosts),
            isPumped: data.isPumped,
            isMicle: data.isMicle,
            isMinimize: data.isMinimize,
            randomBoosts: data.randomBoosts,
            stockpile: data.stockpile,
            originalCurHP: data.originalCurHP,
            status: data.status,
            volatileStatus: data.volatileStatus.slice(),
            ...
            timesFainted: data.timesFainted,
            types: data.types,
            hasExtraType: data.hasExtraType,
            // lastMoveFailed: data.lastMoveFailed,
            moves: data.moves.slice(),
            abilityNullified: data.abilityNullified,
            permanentAtkCheers: data.permanentAtkCheers,
            permanentDefCheers: data.permanentDefCheers,
            overrides: data.species,
        }),
        data.moveData,
        data.extraMoves,
        data.extraMoveData,
        new CumulativeRolls(data.cumDamageRolls.rolls.map(r => Object.keys(r).length > 0 ? new Map(r) : new Map<number,number>()), data.cumDamageRolls.persistentConditions.map(pc => getConditionalRoll(pc.name)!), data.cumDamageRolls.sequentialConditions.map(sc => getConditionalRoll(sc.name)!)),
        data.koChance,
        data.isEndure,
        data.isTaunt,
        data.firstTauntTurn,
        ...
        data.lastAccuracy,
        data.moveRepeated,
        data.movesUsed || [false, false, false, false],
        data.teraCharge,
        data.cheersLeft,
        data.isChoiceLocked,
        data.isEncore,
        ...
        data.disabledMove,
        data.isThroatChop,
        data.shieldActivateHP,
        data.shieldBroken,
        data.shieldBreakStun,
        data.substitute,
        data.originalAbility,
        data.syrupBombDrops,
        data.lastConsumedItem,
        data.preventBelch,
        data.isCudChew,
        data.isTransformed,
        data.isChangedForm,
        ...
        data.originalMoves,
        data.originalAbility,
        data.slowStartCounter,
        data.delayedMoveCounter,
        data.delayedMoveSource,
        data.delayedMoveOptions,
        data.delayedMove,
    )
}