...
const MAIN_STRATS = [ // manually include ones that aren't named "main" (mostly trios)
  "walking_wake/drifting_duo",
  "samurott/tauros",
  "iron_leaves/krook_duo",
  "chesnaught/ghold",
  ...
  "dragapult/to_the_moon_3",
  "charizard/meteor_shower",
  "charizard/meteor_shower_3",
  "venusaur/hammer_time_3",
  "venusaur/winter_migration_4",
  "venusaur/winter_migration_3",
  "blastoise/blast_respects",
  "blastoise/blast_respects_3",
  "blastoise/blazing_blastoise_barrage",
  "blastoise/blazing_blastoise_barrage_3",
  "meganium/angry_krok",
  "meganium/angry_krok_3",
  "typhlosion/fiery_fury",
  "typhlosion/fiery_fury_3",
  "typhlosion/fiery_fury_2",
  "feraligatr/latr_feraligatr",
  "feraligatr/latr_feraligatr_3",
  "feraligatr/boot_scute_boogie",
  "feraligatr/boot_scute_boogie_3",
]
